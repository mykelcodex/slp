...
- **Type**: `font-display` Cormorant Garamond (headings, weight 500–600, italic gold `<em>` accent words); `font-sans` Manrope (body/UI); ``JetBrains Mono (numbers, step indices). Hero H1`clamp(46px,8.4vw,108px)`; section H2 `clamp(34px,4.4vw,56px)`; eyebrows 12px / 0.22em tracking / uppercase.
